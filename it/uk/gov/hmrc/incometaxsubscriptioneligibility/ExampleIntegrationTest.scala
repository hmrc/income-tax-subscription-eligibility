package uk.gov.hmrc.incometaxsubscriptioneligibility
...
class ExampleIntegrationTest extends WordSpec with Matchers with ServiceSpec  {
  ...
  "This integration test" should {
    "start services via smserver" in {
      ...
      val response = wsClient.url(resource("/income-tax-subscription-eligibility/hello-world")).get.futureValue
